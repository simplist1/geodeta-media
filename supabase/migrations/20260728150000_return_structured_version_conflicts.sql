...
is 'Atomically uploads versioned media changes for auth.uid(); expected version conflicts return structured data without raising database errors; order-only updates never modify collection parent_id.';
